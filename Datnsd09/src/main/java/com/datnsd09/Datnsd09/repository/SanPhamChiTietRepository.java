...
//                                      @Param("idLoaiDe") Long idLoaiDe, @Param("idKichCo") Long idKichCo);
    ...
    //Thống kê
    @Query("select ctsp.sanPham.ten,ctsp.kichCo.ten,ctsp.mauSac.ten,ctsp.loaiDe.ten,ctsp.soLuong " +
            "from SanPhamChiTiet ctsp where ctsp.soLuong <= :soLuong and ctsp.trangThai = 0")
